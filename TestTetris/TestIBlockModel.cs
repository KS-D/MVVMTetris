...
namespace TestTetris
{
    ...
    public class TestIBlockModel
    {
        ...
        ShapeModel blockShape = new IBlockModel(grid);
        ...
        public void Test_Move_Left()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                Console.WriteLine(prevX[i]);
            }
            for (int i = 0; i < 4; i++)
            {
                Console.WriteLine(blockShape.ShapeBlocks[i].GridX);
            }
        ...
        public void Test_Drop_Shape()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                Assert.AreEqual(4, blockShape.ShapeBlocks[i].GridY);
            }
        }
